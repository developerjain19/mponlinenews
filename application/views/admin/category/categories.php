                                        ...
                                        foreach ($categories as $item) :
                                            ...
                                            <tr>
                                                ...
                                                <td class="project-actions ">
                                                    ...
                                                    <a class="btn btn-info btn-sm" href="<?= base_url('edit-category/' . encryptId($item['id'])); ?>">
                                                        <i class="fas fa-pencil-alt">
                                                        </i>
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Are You sure?')" href="<?php echo base_url() . 'admin_Dashboard/categories?BdID=' . encryptId($item['id'])  ?>">
