        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <a href="<?= base_url('add-post?type=article'); ?>">
                                <div class="item">
                                    <div class="item-icon">
                        ...
                        <div class="col-sm-4">
                            <a href="<?= base_url('add-post?type=gallery'); ?>">
                                <div class="item">
                                    <div class="item-icon">
                        ...
                        <div class="col-sm-4">
                            <a href="<?= base_url('add-post?type=sorted_list'); ?>">
                                <div class="item">
                                    <div class="item-icon">
                        ...
                        <div class="col-sm-4">
                            <a href="<?= base_url('add-post?type=trivia_quiz'); ?>">
                                <div class="item">
                                    <div class="item-icon">
                                    ...
                                    <h5 class="title">Trivia Quiz</h5>
                                    <p class="desc">Quizzes with right and wrong answers</p>
                                </div>
                            </a>
                        </div>

                        <div class="col-sm-4">
                            <a href="<?= base_url('add-post?type=personality_quiz'); ?>">
                                <div class="item">
                                    <div class="item-icon">
                                    ...
                                    <h5 class="title">Personality Quiz</h5>
                                    <p class="desc">Quizzes with custom results</p>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <a href="<?= base_url('add-post?type=video'); ?>">
                                <div class="item">
                                    <div class="item-icon">
                                    ...
                                    <p class="desc">Upload or embed videos</p>
                                </div>
                            </a>
                        </div>

                        <div class="col-sm-4">
                            <a href="<?= base_url('add-post?type=audio'); ?>">
                                <div class="item">
                                    <div class="item-icon">
                                    ...
                                    <p class="desc">Upload audios and create playlist</p>
                                </div>
                            </a>
                        </div>
